  ...
  const handleStudentSelect = (student) => {
    ...
    if (existingConversation) {
      ...
      setSelectedConversation({
        prof_id: userInfo.id,
        prof_username: userInfo.username,
  ...
  const handleSendMessage = async (e) => {
    ...
    try {
      ...
      const response = await api.post("/messages", {
        receiver_id: selectedConversation.student_id,
      ...
      if (!selectedConversation.conversation_id) {
        ...
        const newConversation = {
          ...
          student_username: selectedConversation.student_username,
          ...
          {conversations.map(conv => (
            ...
            >
              <div className="conversation-info">
                <div className="conversation-name">{conv.student_username}</div>
        ...
        {selectedConversation ? (
          <>
            <div className="chat-header">
              <h2>{selectedConversation.student_username}</h2>
            </div>
          ...
          <div className="no-conversation">
            <p>Sélectionnez une conversation ou un étudiant pour commencer à discuter</p>
          </div>
        )}
      </div>
